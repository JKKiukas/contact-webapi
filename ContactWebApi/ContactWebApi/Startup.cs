...
namespace ContactWebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ContactWebapiContext>(opt =>
            {
                //opt.UseSqlServer(Configuration.GetConnectionString("LocalContactWebapiContext"));
                //opt.UseSqlServer(Configuration.GetConnectionString("AzurePersonDBContext"));
                opt.UseSqlServer(Configuration.GetConnectionString("ContactsDBUser"));
            });
